<h2> 117 45
2817. Minimum Absolute Difference Between Elements With Constraint</h2><hr><div><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code> and an integer <code>x</code>.</p>
